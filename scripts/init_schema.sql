...
INSERT INTO devices (id, secret_key, name, product_id, group_id,
                               features, state, version, sdk_version, ip, online, location,
                               status, created_at, active_at, updated_at)
VALUES
    ('dev-001', 'device-secret-001', 'Temperature Sensor NYC', 'prod-001', 'group-001',
     ...
     true, NOW(), NOW(), NOW()),
    ('dev-002', 'device-secret-002', 'Camera Device Beijing', 'prod-001', 'group-002',
